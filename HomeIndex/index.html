				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						<div class="banner-content col-lg-9 col-md-12">
							...
							<a href="Reset&register/Register/Registerform.php" class="primary-btn text-uppercase">Beli sekarang</a>
						</div>											
					</div>
			</section>
			<!-- End banner Area -->		
...
<div class="container">
		<div id="poptrox">
			<ul id="gallery">
				<li class="nopad"><img src="img/1.PNG" width="270" height="270" alt="" title="gambar belum keluar" /></li>
				<li><img src="img/2.PNG" width="270" height="270"  alt="" title="gambar belum keluar" /></li>
				<li><img src="img/3.PNG" width="270" height="270"  alt="" title="gambar belum keluar" /></li><br>
				<li class="nopad"><img src="img/4.PNG" width="270" height="270"  alt="" title="gambar belum keluar" /></li>
				<li><img src="img/5.PNG" width="270" height="270" alt="" title="gambar belum keluar" /></li>
				<li><img src="img/6.PNG" width="270" height="270"  alt="" title="gambar belum keluar" /></li>
			</ul>
</div>
</div>
</section>	
